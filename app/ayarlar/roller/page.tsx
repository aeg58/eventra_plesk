...
const mockRoles: Role[] = [
  {
    id: 1,
    name: 'Admin',
    description: 'Tam yetkiye sahip yönetici rolü',
    isDefault: false,
    isActive: true,
  ...
  {
    id: 2,
    name: 'Çağrı Merkezi ve Rezervasyon',
    description: 'Rezervasyon işlemlerini yönetebilir',
    isDefault: true,
    isActive: true,
    ...
    <div className="max-w-7xl mx-auto">
      ...
      {showToast && (
        <div className="fixed top-20 right-6 bg-green-600 text-white px-6 py-3 rounded-lg shadow-lg z-50 flex items-center gap-2">
          <span>Rol başarıyla {editingRole ? 'güncellendi' : 'oluşturuldu'} ✅</span>
        </div>
      )}
